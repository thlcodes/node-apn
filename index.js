...
const framer     = require("node-http2/lib/protocol/framer");
const compressor = require("node-http2/lib/protocol/compressor");
...
const protocol = {
  ...
  Connection:   require("node-http2/lib/protocol/connection").Connection,
};
